    ...
    <>
      <div className="w-full border-2 rounded-2xl border-gray-200 py-6">
        <div className="mx-auto flex justify-center">
          {" "}
          <img className=" h-20  w-20 " src={img} alt="Blog Cover" />
        </div>
  ...
  return (
    <>
      <div className="text-center">
        <h1 className="text-2xl px-10 font-bold md:text-3xl lg:text-5xl">
          {" "}
          <span className="text-green-700 ">Hajir Khata</span> , The Trusted
          payroll and attendence solution for your business.
        </h1>
        <p className="px-10 py-5">
          Steamless both payroll and attendance management with solutions
